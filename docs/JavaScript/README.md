...
### 4. 使用 `PureComponent` / `React.memo` (SCU)
...
### 7. 事件的防抖 (Debounce) 与 节流 (Throttle)
...
### 9. 虚拟滚动 (Virtual Scrolling / Windowing)
